...
import { TestTube2, User, LogOut, Settings, FileText, Building2, ShieldCheck, LayoutDashboard } from "lucide-react";
              ...
              <>
                ...
                {isAdmin && (
                  <div className="flex items-center gap-1.5 bg-violet-600/20 border border-violet-400/30 backdrop-blur-sm px-3 py-1.5 rounded-xl">
                    ...
                    <span className="text-xs font-bold text-violet-200">Admin</span>
                  </div>
                )}
                ...
                >
                  ...
                  >
                    ...
                    {isAdmin && (
                      <DropdownItem
                        key="admin-dashboard"
                        startContent={<LayoutDashboard className="w-4.5 h-4.5 text-violet-500 mr-2" />}
                    ...
                    {!isAdmin && (
                      <DropdownItem
                        key="profile"
                        startContent={<User className="w-4.5 h-4.5 text-emerald-500 mr-2" />}
                      >
                        My Profile
                      </DropdownItem>
                    )}
                    ...
                    {!isAdmin && (
                      <DropdownItem
                        key="settings"
                        startContent={<Settings className="w-4.5 h-4.5 text-emerald-500 mr-2" />}
                      >
                        Settings
                      </DropdownItem>
                    )}
